<form action="<?php echo site_url('/customer/') ?>" method="POST">
	<div class="modal-body">
		<input type="hidden" name="id_customer" value="<?php echo $data[0]->id_customer;?>">
		<div class="row">
			<div class="col-sm-12">
					<div class="form-group form-floating-label">
						<input name="nama_customer" value="<?php echo $data[0]->nama_customer;?>" autocomplete="off" id="inputFloatingLabel2" type="text" class="form-control input-solid" size="20" onkeyup="this.value = this.value.toUpperCase()" required>
