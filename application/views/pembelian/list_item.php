      ...
      <div class="modal fade" id="addRowModal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <input type="text" name="id_pembelian" value="<?php echo $header[0]->id_pembelian;?>">
						  <div class="modal-body">
                            ...
                            $this->db->where('obat.id_supplier',$header[0]->id_supplier);
                            $query = $this->db->get();            
            ...
            <tr>
              ...
              <td><?php echo number_format($u->total) ?></td>
							...
							<div class="form-button-action">
								...
								<a href="javascript:void(0)" onclick="$('#view-modal').modal('show');" data-id="<?php echo $u->id_detail_masuk; ?>" id="get_data" data-toggle="tooltip" title="Approval">
									<span class="selectgroup-button selectgroup-button-icon"><i class="fas fa-edit btn btn-warning btn-xs"></i></span>
								</a>
								</label>
								<label class="selectgroup-item">
									<a href="<?php echo base_url('pembelian/delete_item/'.$u->id_detail_masuk.'/'.$u->id_pembelian)?>" onclick="return confirm('Apakah anda yakin ingin menghapus item?')">
