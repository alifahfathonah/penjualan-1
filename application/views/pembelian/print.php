    ...
    <div class="card">
      <div class="card-body">
        <div class="col-md-12">
          ...
          <input disabled value="<?php echo $header[0]->id_pembelian;?>" name="id_pembelian" autocomplete="off" id="inputFloatingLabel2" type="text" class="form-control input-solid">
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
          ...
          <input disabled value="<?php echo $header[0]->tanggal_pembelian.' '.$header[0]->jam_pembelian;?>" name="tanggal_pembelian" autocomplete="off" id="inputFloatingLabel2" type="text" class="form-control input-solid" size="20">
        </div>
      </div>
      <div class="card-body">
